  ...
  return (
    ...
    <footer className="bg-gray-800  text-white">
      <div className="mx-auto max-w-screen-xl px-4 pb-1 pt-6 sm:px-6 lg:px-8">
        <div className="mt-2 grid grid-cols-1 gap-8  border-gray-100 pt-8 dark:border-gray-800 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="text-center sm:text-left md:col-span-4 lg:col-span-2">
            ...
            <div className="mx-auto mt-8 max-w-md sm:ms-0">
              <p className="leading-relaxed text-gray-300 dark:text-gray-400 ltr:sm:text-left rtl:sm:text-right">
